...
The meal protein contents of these lines with high protein and normal oil contents ranged from 103.8% -- 108.5% compared to the meal protein contents of the checks. This corresponds to protein meal concentrations between 50.8%-53.9%. Breeding line N18-1783 from test 2 had the maximum protein meal from among these lines. (Supplementary table 2).
...
```{r elite_geno_table, echo = FALSE}

knitr::knit_print(elite_genotype_tables$elite_genos$word_table)
...
```{r high_po_table, echo = FALSE}

knitr::knit_print(elite_genotype_tables$hp_sy_table$word_table)
