...
These thirty lines were then grouped into two new tests of 15 RILs each which were then grown in both the 2020 and 2021 seasons. These tests were grown in CLA and CAS in 2020 and CAS and PLY in 2021.

## Statistical Analysis
The data for seed yield, seed oil, and seed protein contents were analyzed using a mixed model with the metan[@olivotoMetanPackageMultienvironment2020] R package. Environment, replication nested with environment, and the interaction of genotype with environment were considered to be random effects while genotype was considered to be a fixed effect. 
