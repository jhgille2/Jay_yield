...
\Author{Jay
Gillenwater$^{1,2,\ddagger,*}$\href{https://orcid.org/0000-0003-3293-2315}{\orcidicon}, John
Doe$^{2, \dagger, \ddagger}$}

% Authors, for metadata in PDF
\AuthorNames{Jay Gillenwater, John Doe}
...
Country; \href{mailto:jhgille2@ncsu.edu}{\nolinkurl{jhgille2@ncsu.edu}}\\
}
...
which were then grown in both the 2020 and 2021 seasons. Thesew tests
